...
In an earlier challenge, you used the caret character (^) inside a character set to create
 a negated character set in the form [^thingsThatWillNotBeMatched]. Outside of a character 
...
Program-Use the caret character in a regex to find Cal only in the beginning of the string
 rickyAndCal.
...
let result = calRegex.test(rickyAndCal);<ixp
