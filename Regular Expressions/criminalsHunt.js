...
Time to pause and test your new regex writing skills. A group of criminals
 escaped from jail and ran away, but you don't know how many. However, you 
 do know that they stay close together when they are around other people.
...
let findCriminalInString= string.match(reCriminals);
console.log(findCriminalInString);
