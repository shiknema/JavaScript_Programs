...
still point to the altered array [5, 6, 45]. Like all arrays, the array elements in s 
are mutable, but because const was used, you cannot use the variable identifier s to
 point to a different array using the assignment operator.
**************************************************************************************

Problem-An array is declared as const s = [5, 7, 2]. Change the array to [2, 5, 7]
...
console.log(" Before called the function s[1] = ",s[1]);
editInPlace() 
console.log(" After called the function s[1]= ",s[1]);